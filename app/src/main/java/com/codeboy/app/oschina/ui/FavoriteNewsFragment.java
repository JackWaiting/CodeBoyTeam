...
/**
 * 类名 FavoriteNewsFragment.java</br>
 * 创建日期 2014年5月9日</br>
 * @author LeonLee (http://my.oschina.net/lendylongli)</br>
 * Email lendylongli@gmail.com</br>
 * 更新时间 2014年5月9日 下午10:23:27</br>
 * 最后更新者 LeonLee</br>
 * 
 * 说明 收藏夹-资讯
 */
public class FavoriteNewsFragment extends BaseSwipeRefreshFragment<Favorite, FavoriteList>{
	...
	protected MessageData<FavoriteList> asyncLoadList(int page, boolean reflash) {
		...
		try {
			FavoriteList list = mApplication.getFavoriteList(
					FavoriteList.TYPE_NEWS, page, reflash);
