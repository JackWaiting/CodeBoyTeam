...
/**
 * 类名 SoftwareChinaFragment.java</br>
 * 创建日期 2014年4月25日</br>
 * @author LeonLee (http://my.oschina.net/lendylongli)</br>
 * Email lendylongli@gmail.com</br>
 * 更新时间 2014年4月25日 上午12:23:43</br>
 * 最后更新者 LeonLee</br>
 * 
 * 说明 开源软件库-国内
 */
public class SoftwareChinaFragment extends BaseSwipeRefreshFragment<SimpleSoftware, SoftwareList>{
	...
	protected MessageData<SoftwareList> asyncLoadList(int page, boolean reflash) {
		...
		try {
			SoftwareList list = mApplication.getSoftwareList(SoftwareList.TAG_CHINA, page, reflash);
