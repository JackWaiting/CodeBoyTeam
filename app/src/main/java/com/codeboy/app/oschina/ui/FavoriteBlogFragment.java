...
/**
 * 类名 FavoriteBlogFragment.java</br>
 * 创建日期 2014年5月9日</br>
 * @author LeonLee (http://my.oschina.net/lendylongli)</br>
 * Email lendylongli@gmail.com</br>
 * 更新时间 2014年5月9日 下午10:22:21</br>
 * 最后更新者 LeonLee</br>
 * 
 * 说明 收藏夹-博客
 */
public class FavoriteBlogFragment extends BaseSwipeRefreshFragment<Favorite, FavoriteList>{
	...
	protected MessageData<FavoriteList> asyncLoadList(int page, boolean reflash) {
		...
		try {
			FavoriteList list = mApplication.getFavoriteList(
					FavoriteList.TYPE_BLOG, page, reflash);
