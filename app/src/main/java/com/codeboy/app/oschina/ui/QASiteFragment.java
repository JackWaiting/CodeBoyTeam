...
/**
 * 类名 QASiteFragment.java</br>
 * 创建日期 2014年4月24日</br>
 * @author LeonLee (http://my.oschina.net/lendylongli)</br>
 * Email lendylongli@gmail.com</br>
 * 更新时间 2014年4月24日 下午8:41:05</br>
 * 最后更新者 LeonLee</br>
 * 
 * 说明 问答-站务
 */
public class QASiteFragment extends BaseSwipeRefreshFragment<Post, PostList>{
	...
	protected MessageData<PostList> asyncLoadList(int page, boolean reflash) {
		...
		try {
			PostList list = mApplication.getPostList(PostList.CATALOG_SITE, page, reflash);
