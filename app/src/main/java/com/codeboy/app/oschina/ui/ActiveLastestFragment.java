...
/**
 * 类名 ActiveLastestFragment.java</br>
 * 创建日期 2014年4月28日</br>
 * @author LeonLee (http://my.oschina.net/lendylongli)</br>
 * Email lendylongli@gmail.com</br>
 * 更新时间 2014年4月28日 上午1:05:56</br>
 * 最后更新者 LeonLee</br>
 * 
 * 说明 我的空间-最新动态
 */
public class ActiveLastestFragment extends BaseSwipeRefreshFragment<Active, ActiveList> {
	...
	protected MessageData<ActiveList> asyncLoadList(int page, boolean reflash) {
		...
		try {
			ActiveList list = mApplication.getActiveList(
					ActiveList.CATALOG_LASTEST, page, reflash);
